                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 mt-12 gap-16">
                  ...
                  <div className="dashboard-calendary">
                    <div className="dashboard-date flex justify-between">
                      <h2 className="text-[30px] text-[#FFF] font-bold">
                        January
                      </h2>
                      <div className="items-center justify-center flex">
                        <button
                          type="button"
                          className="text-[#D1D5DB] border-2 border-[#D1D5DB]/15 p-2 rounded-full">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                    ...
                    <div className="my-2 border-t-4 border-[#F1F5F9]/25 rounded-lg">
                      ...
                      <div className="flex justify-end items-end">
                        <button
                          type="button"
                          className="text-[#FFF] text-[14px] w-full lg:w-auto font-medium bg-[#355AD4] px-4 py-2 rounded-lg mt-6">
                          More Details
                        </button>
                      </div>
                    </div>
