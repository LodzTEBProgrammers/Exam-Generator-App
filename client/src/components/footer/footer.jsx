        ...
        <footer className="footer relative z-10 flex justify-center items-center h-full">
            <div className="container w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="flex items-center justify-between px-2">
                    ...
                    <div className="flex gap-3 grid-cols-1">
                        <a href="" className="text-white bg-white/15 p-2 rounded-full">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <div className="flex mt-4 mb-4 sm:justify-center sm:mt-0 sm:mb-0">
                        ...
                        <span className="text-md text-white mx-2">•</span>
                        <a href="#" className="text-md text-white">
                            Terms of Service
                        </a>
                    </div>
                    <p className="text-md text-[#d1d5db] sm:text-center">© 2023 All Rights Reserved</p>
                </div>
            </div>
        </footer>
